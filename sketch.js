...
function setup() {
  ...
  // color pickers
  primaryColorPicker = createColorPicker(color(300, 100, 30))
    .class("color-picker")
    .parent(primaryLabel);
  secondaryColorPicker = createColorPicker(color(300, 100, 60))
    .class("color-picker")
    .parent(secondaryLabel);
  backgroundColorPicker = createColorPicker(color(300, 100, 90))
    .class("color-picker")
